...
- **11 различных конечных точек** для разных сценариев использования
...
3. При желании отредактируйте `src/fragment_settings.py`, чтобы настроить продвинутую фрагментацию TLS, используемую в конечной точке Fragment
4. Включите GitHub Actions в вашем fork'е  
5. Конфигурации будут автоматически обновляться по расписанию проекта
...
6. Тестирование с Sing-box core (многораундовое)
7. Фильтрация по безопасности и генерация безопасных версий для Sing-box и Xray
8. Генерация конфигураций Clash/Mihomo YAML
9. Генерация конфигурации Xray с балансировкой нагрузки
10. Генерация конфигурации Xray с балансировкой нагрузки и Fragment
11. Обновление диаграмм и отчётов
12. Генерация сводки по запуску пайплайна
13. Коммит и пуш изменений
